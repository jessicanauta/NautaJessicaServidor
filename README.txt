...
a persistence unit "NautaJessicaServidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "NautaJessicaServidor\pom.xml":
...
artifact ("NautaJessicaServidor.war") is already built. You can build
